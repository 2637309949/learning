...
[understandinges6-simplified-chinese](https://www.gitbook.com/book/oshotokill/understandinges6-simplified-chinese/details)  
...
[static（调用一个静态方法，使用this关键字）](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Classes/static)  
#### 装饰器
